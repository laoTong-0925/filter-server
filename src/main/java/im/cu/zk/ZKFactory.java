//package im.cu.zk;
//
//import com.wealoha.common.notify.NotifyCallback;
...
//                List<String> children = zooKeeper.getChildren(ZKConfigKey.filterServerNopePath, true);
...
//                log.debug("child of {}: {}", ZKConfigKey.filterServerNopePath, child);
//                Stat stat = new Stat();
//                byte[] data = zooKeeper.getData(ZKConfigKey.filterServerNopePath + "/" + child, true, stat);
...
//        try {
//            String wholePath = ZKConfigKey.filterServerNopePath + "/" + url;
...
//
//            default:
//                log.debug("ignore event({}): {}, {}", ZKConfigKey.filterServerNopePath, event.getType(), event);
//                break;
//        }
//
//
...
//                return;
//            try {
//                log.info("reload notify config for event({}): {}, {}", ZKConfigKey.filterServerNopePath,
//                        event.getType(), event);
...
//                    }
//                }
//                if (zkPath.contains(ZKConfigKey.filterServerNopePath)) {
